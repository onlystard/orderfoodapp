...
import 'package:testproject/src/admin/pages/add_food_item.dart';
import 'package:testproject/src/scoped-model/main_model.dart';
import 'package:testproject/src/widgets/food_item_card.dart';
    ...
    return Scaffold(
      ...
      body: ScopedModelDescendant<MainModel>(
        builder: (BuildContext sctx, Widget child, MainModel model) {
          model.fetchFoods();
          // this will fetch and notifylisteners()

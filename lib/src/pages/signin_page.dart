...
import 'package:testproject/src/pages/forgotpassword_page.dart';
import 'package:testproject/src/scoped-model/main_model.dart';
import 'package:testproject/src/widgets/button.dart';
    ...
    return ScopedModelDescendant(
      builder: (BuildContext sctx, Widget child, MainModel model) {
        return GestureDetector(
          onTap: () {
            showLoadingIndicator(context, "Đăng nhập...");
            onSubmit(model.authenticate);
          },
          child: Button(btnText: "Đăng nhập"),
        );
      },
    );
  }

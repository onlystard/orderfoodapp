...
import 'package:testproject/src/models/user_info_model.dart';
import 'package:testproject/src/models/user_model.dart';
  ...
  Future<bool> fetchUserInfos() async {
    ...
    try {
      final http.Response response = await http
          .get("https://foodie-47add-default-rtdb.firebaseio.com/users.json");
  ...
  Future<bool> addUserInfo(Map<String, dynamic> userInfo) async {
    ...
    try {
      final http.Response response = await http.post(
          "https://foodie-47add-default-rtdb.firebaseio.com/users.json",
    ...
    try {
      ...
      if (authMode == AuthMode.SignUp) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDv9mD5SvpetBEMuVHWTVhruiCo-qxER28",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      } else if (authMode == AuthMode.SignIn) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDv9mD5SvpetBEMuVHWTVhruiCo-qxER28",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      }
